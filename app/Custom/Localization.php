...
class Localization
{
    ...
    function __construct($language_code, $data)
    {
        ...
        $this->english = [
            ...
            "identity_verification_success_under_age" => "Your identity was successfully verified but you can not be verified on Megalo because you need to be 18 years or older to use Megalo.",
            "identity_verification_success_estimate_under_age" => "Your identity was successfully verified but our system determined that you are not up to 18 years old. You can not be verified on Megalo because you need to be 18 years or older to use Megalo.",
            ...
            "test_body" => "Keep calm, this is just a test.",
        ...
        $this->german = [
            ...
            "identity_verification_success_under_age" => "Ihre Identität wurde erfolgreich verifiziert, aber Sie können nicht auf Megalo verifiziert werden, da Sie mindestens 18 Jahre alt sein müssen, um Megalo zu verwenden.",
            "identity_verification_success_estimate_under_age" => "Ihre Identität wurde erfolgreich verifiziert, aber unser System hat festgestellt, dass Sie nicht älter als 18 Jahre sind. Sie können nicht auf Megalo verifiziert werden, da Sie mindestens 18 Jahre alt sein müssen, um Megalo zu verwenden.",
            ...
            "test_title" => "Das ist ein Test",
            "test_body" => "Bleiben Sie ruhig, das ist nur ein Test.",
