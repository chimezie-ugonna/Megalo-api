...
class Localization
{
    ...
    function __construct($ip_address, $data)
    {
        $this->english = [
            ...
            "referral_bonus_received_body_referrer" => "You have just received $" . $data["referral_payment_usd"] . " in your balance because someone you referred with your referral code has invested $100 or more on Megalo. Keep referring people to earn more!",
            "referral_bonus_received_body_referree" => "You have just received $" . $data["referral_payment_usd"] . " in your balance because you joined Megalo with someone's referral code and have invested $100 or more on Megalo. You can earn more if you refer someone too.",
            ...
            "property_dividend_payment_body" => "You just received $" . $data["user_percentage_of_property_monthly_earning"] . " in your balance as dividend from a property you invested in.",
            ...
            "property_sale_payment_body" => "You just received $" . $data["user_percentage_of_property_value"] . " in your balance as payment from the sale of a property you invested in.",
            ...
            "insufficient_fund_email_body" => "A payment failure has just occurred while a user was trying to withdraw a sum of $" . $data["amount"] . " from their Megalo balance. This failure occurred because there is not enough money in Megalo's stripe account balance for that transaction. A top up of Megalo's stripe account balance with enough money to cover the user's withdrawal amount ($" . $data["amount"] . ") is required as soon as possible so as to not degrade the user's experience on Megalo.",
        ...
        $this->german = [
            ...
            "referral_bonus_received_body_referrer" => "Sie haben gerade $" . $data["referral_payment_usd"] . " auf Ihrem Guthaben erhalten, weil jemand, den Sie mit Ihrem Empfehlungscode geworben haben, 100 $ oder mehr bei Megalo investiert hat. Empfehlen Sie weiter Leute, um mehr zu verdienen!",
            "referral_bonus_received_body_referree" => "Sie haben gerade $" . $data["referral_payment_usd"] . " auf Ihrem Guthaben erhalten, weil Sie Megalo mit dem Empfehlungscode einer anderen Person beigetreten sind und 100 $ oder mehr in Megalo investiert haben. Sie können mehr verdienen, wenn Sie auch jemanden empfehlen.",
            ...
            "property_dividend_payment_body" => "Sie haben gerade $" . $data["user_percentage_of_property_monthly_earning"] . " in Ihrem Guthaben als Dividende von einer Immobilie erhalten, in die Sie investiert haben.",
            ...
            "property_sale_payment_body" => "Sie haben gerade $" . $data["user_percentage_of_property_value"] . " als Zahlung für den Verkauf einer Immobilie erhalten, in die Sie investiert haben.",
            ...
            "insufficient_fund_email_body" => "Ein Zahlungsfehler ist gerade aufgetreten, während ein Benutzer versucht hat, eine Summe von $" . $data["amount"] . " von seinem Megalo-Guthaben abzuheben. Dieser Fehler ist aufgetreten, weil auf dem Stripe-Konto von Megalo nicht genügend Geld für diese Transaktion vorhanden ist. Eine Aufladung des Stripe-Kontostands von Megalo mit genügend Geld zur Deckung des Auszahlungsbetrags des Benutzers ($" . $data["amount"] . ") ist so schnell wie möglich erforderlich, um die Erfahrung des Benutzers auf Megalo nicht zu beeinträchtigen.",
