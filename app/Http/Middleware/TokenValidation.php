...
class TokenValidation
{
    ...
    {
        if ($request->path() != "api/v1/user/send_otp" && $request->path() != "api/v1/user/verify_otp" && $request->path() != "api/v1/user/verify_identity_webhook" || $request->path() == "api/v1/user/send_otp" && $request->request->has("update") && $request->filled("update") && $request->request->get("update") || $request->path() == "api/v1/user/verify_otp" && $request->request->has("update") && $request->filled("update") && $request->request->get("update") || $request->path() == "api/v1/user/send_otp" && $request->request->has("type") && $request->filled("type") && $request->request->get("type") == "email" || $request->path() == "api/v1/user/verify_otp" && $request->request->has("type") && $request->filled("type") && $request->request->get("type") == "email") {
